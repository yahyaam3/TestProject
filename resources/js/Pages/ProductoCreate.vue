<template>
    <div class="container mx-auto p-4">
        <h1 class="text-xl font-bold mb-4" tabindex="0">Crear Producto</h1>
        <div class="bg-white p-4 border rounded shadow">
            <form @submit.prevent="submit" aria-label="Formulario para crear producto">
                <div class="mb-3">
                    ...
                    />
                    <span v-if="form.errors.nombre" class="text-red-700 text-sm" role="alert">{{ form.errors.nombre }}</span>
                </div>
                ...
                <div class="mb-3">
                    ...
                    />
                    <span v-if="form.errors.precio" class="text-red-700 text-sm" role="alert">{{ form.errors.precio }}</span>
                </div>
                ...
                <div class="mb-3">
                    ...
                    ></textarea>
                    <span v-if="form.errors.descripcion" class="text-red-700 text-sm" role="alert">{{ form.errors.descripcion }}</span>
                </div>
